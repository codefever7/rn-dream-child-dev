...
export default ({
  ...
  }, [hideControls, play, ready]);

  const progress = currentTime !== 0 && duration !== 0 ? currentTime / duration : 0;

  return (
    <View style={[styles.container, { paddingHorizontal: fullScreen ? 40 : 0 }]} pointerEvents='auto'>
      <TouchableWithoutFeedback
        onPress={() => {
          hideAfterExecute(setVisible)(true);
        }}
          ...
          <View
            ...
            <View style={[styles.footer, { bottom: fullScreen ? 30 : 10 }]}>
              ...
              <View style={styles.footerRight}>
                ...
                {showFullScreenButton && (
                  <React.Fragment>
                    {fullScreen ? <ExitFSIcon size={16} onPress={toggleFS} /> : <FSIcon size={16} onPress={toggleFS} />}
                  </React.Fragment>
                )}
              </View>
            </View>
      ...
      <ProgressBar value={progress} {...{ fullScreen, visible, seekTo, duration, pauseVideo, playVideo }} />
    </View>
  );
};
